...
import Lib.mega.cmd.FileInfo;
import Lib.mega.cmd.MegaCmdChangePassword;
import Lib.mega.cmd.MegaCmdCopy;
import Lib.mega.cmd.MegaCmdExport;
import Lib.mega.cmd.MegaCmdGet;
import Lib.mega.cmd.MegaCmdHttps;
import Lib.mega.cmd.MegaCmdImport;
import Lib.mega.cmd.MegaCmdList;
import Lib.mega.cmd.MegaCmdLogout;
import Lib.mega.cmd.MegaCmdMakeDirectory;
import Lib.mega.cmd.MegaCmdMove;
import Lib.mega.cmd.MegaCmdPutMultiple;
import Lib.mega.cmd.MegaCmdPutSingle;
import Lib.mega.cmd.MegaCmdRemove;
import Lib.mega.cmd.MegaCmdSession;
import Lib.mega.cmd.MegaCmdShare;
import Lib.mega.cmd.MegaCmdWhoAmI;
...
public class MegaSession {
   ...
   *
   * @param remotePath {@link String} with the remote path
   * @param predicate {@link Predicate} that will filter the count of elements to have in
   * count
   * @return {@link Long} with the amount of elements
   * @see #count(String)
   */
